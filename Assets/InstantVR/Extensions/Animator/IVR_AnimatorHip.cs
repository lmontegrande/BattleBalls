 ...
 * date: August 5, 2016
 *
 * fixed hips being everywhere when rotating avatar
 */
...
namespace IVR {
    ...
    public class IVR_AnimatorHip : IVR_Controller {
        ...
        private void FollowHead() {
            //Vector3 oldHipPosition = ivr.hipTarget.position;
            ...
            if (bodyStretch.y >= -0.05F) {
                ...
                //float deltaY = ivr.headTarget.position.y - ivr.transform.position.y - Mathf.Sqrt(spineLength * spineLength - deltaXZ.magnitude * deltaXZ.magnitude);
