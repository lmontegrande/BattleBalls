 ...
 * date: April 8, 2016
 * 
 * - Beter compatibility with grabbing
 */
    ...
    public class IVR_HydraHand : IVR_HandController {
        ...
        private void UpdateInputSide(ControllerInputSide controllerInput) {
            if (hydraController != null) {
                ...
                controllerInput.bumper = Mathf.Max(controllerInput.bumper, hydraController.GetButton(IVR_Hydra.HydraButtons.BUMPER) ? 1 : 0);
                controllerInput.trigger = Mathf.Max(controllerInput.trigger, hydraController.m_Trigger);
