...
namespace IVR {
    ...
    public class HeadMovementsEdge : HeadMovements {
        ...
        public override void UpdateFocusPoint(bool raycastHit, RaycastHit hit) {
            ...
            if (raycastHit) {
                ...
                if (character != null) {
                    ...
                    lookTransform = character.transform;
        ...
        public override Vector3 DeriveLookDirection(Quaternion headRotation) {
